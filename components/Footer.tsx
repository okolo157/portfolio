...
export default function Footer() {
  return (
    <div className={robotoMono.className}>
      <div className="flex flex-col bg-black text-white text-xl sm:text-2xl md:text-3xl p-4 sm:p-6 md:p-10 items-center gap-4 sm:gap-5 md:gap-7">
        ...
        <div className="flex flex-wrap justify-center text-xs sm:text-sm md:text-base gap-2 sm:gap-3 md:gap-4 max-w-full px-2">
          <Link
          ...
          <Link
            href="www.linkedin.com/in/victorokolo11"
            className="border text-white hover:bg-white hover:text-black transition-colors ease-in-out p-1 sm:p-2 m-1"
          >
            LinkedIn
          </Link>
